...
const ReclamationSection = ({ form, onChange, disabled = false }: ClaimFormSectionProps) => {
  ...
  return (
    <FormSection title="Réclamation">
      ...
      <FormRow label="Agent">
        <ClearableSelect value={form.followedBy} onChange={(value) => onChange("followedBy", value)} disabled={disabled}>
      ...
      <FormRow label="Prestation">
        <ClearableSelect value={form.service} onChange={(value) => onChange("service", value)} disabled={disabled}>
      ...
      <FormRow label="Type Skissim">
        <ClearableSelect value={form.skissimType} onChange={(value) => onChange("skissimType", value)} disabled={disabled}>
      ...
      <FormRow label="Raison">
        <ClearableSelect value={form.reason} onChange={(value) => onChange("reason", value)} disabled={disabled}>
      ...
      <FormRow label="Solution">
        <ClearableSelect value={form.solution} onChange={(value) => onChange("solution", value)} disabled={disabled}>
